...
describe("lifecycle", () => {
  it("should save flow synchronously", (done) => {
      let results = [];
  ...
  it("should save flow asynchronously", (done) => {
      let results = [];
      const observer = createObserver({
          complete: () => {
              expect(results[0]).toBe("exepcted1");
  ...
  it("should complete flow synchronously", (done) => {
      const observer = createObserver();
      const flow = createFlow(function*() {});
  ...
  it("should complete flow asynchronously", (done) => {
      const observer = createObserver();
      const flow = createFlow(function*() {});
  ...
  it("should stop flow execution when save is asynchronous", async () => {
      const observer = createObserver();
