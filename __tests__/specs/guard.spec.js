...
describe("guard", () => {
  it("should guard against yielding object with wrong type", (done) => {
  ...
  it("should guard against yielding object that has no type", (done) => {
      const observer = createObserver({error: (item) => {
  ...
  it("should guard against yielding null", (done) => {
      const observer = createObserver({error: (item) => {
  ...
  it('should guard against null flow', async () => {
      let observer;
  ...
  it('should guard against flow without generator', (done) => {
  ...
  it('should guard against flow without a name', (done) => {
      const observer = createObserver({error: () => done()})
